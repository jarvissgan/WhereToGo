                  ...
                  return Dismissible(
                    ...
                    onDismissed: (direction) {
                      setState(() {
                        ...
                        fsService.removeEntryWithName(changeLists()[i].name);
                      });
                    },
                    child: ListTile(
                      title: Row(children: [
                        if (buttonState)
                          Checkbox(
                            ...
                            onChanged: (bool? newValue) {
                              setState(() {
                                fsService.changeCheckState(i, newValue)[i];
                              });
                            },
                          ),
                        if (buttonState)
